...
var dbConfirm = require('./db/registerconfirm.js');
...
var dbAssetManager = require('./db/assetmanager.js');
...
var dbPartnersRequests = require('./db/partnersrequests.js');
...
var BodegaDb = (function() {
    ...
    BodegaDb.prototype.createAsset = function(req, res) {
        this.dbQuery(dbAssetManager.create, req, res);
    };
    ...
    BodegaDb.prototype.updateAsset = function(req, res) {
        this.dbQuery(dbAssetManager.update, req, res);
    };
    ...
    BodegaDb.prototype.createAssetRating = function(req, res) {
        this.dbQuery(dbRatings.createAssetRating, req, res);
    };
    ...
    BodegaDb.prototype.listAssetTypeTags = function(req, res) {
        this.dbQuery(dbTags.listAssetTypeTags, req, res);
    };

    BodegaDb.prototype.listLicenses = function(req, res) {
        this.dbQuery(dbTags.listLicenses, req, res);
    };
    ...
    BodegaDb.prototype.listPartnerRequests = function(req, res) {
